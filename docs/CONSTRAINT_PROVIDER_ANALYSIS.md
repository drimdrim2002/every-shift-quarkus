...
#### 4. `noThreeConsecutiveNightShifts` (3연속 Night 금지)
*   **내용**: 동일 직원에게 Night 근무가 논리일 기준 3일 연속 배정되는지 확인합니다.
*   **패널티**: 3연속 Night 패턴이 발견되면 점수를 깎습니다 (`ONE_HARD`).
